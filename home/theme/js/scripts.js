...
$(function () {
    ...
    /* ===============================  Swiper slider  =============================== */
	 ...
	 var swiperWorkSlider = new Swiper('.blog-swiper .swiper-container', {
        slidesPerView: 3,
        spaceBetween: 30,
        speed: 1000,
        loop: true,
        ...
        navigation: {
            nextEl: '.blog-swiper .next-ctrl',
            prevEl: '.blog-swiper .prev-ctrl'
        }
    });
